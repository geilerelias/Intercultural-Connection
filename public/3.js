    ...
    [
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("v-btn", { attrs: { to: "about-us", text: "" } }, [
            _vm._v("\n            " + _vm._s(_vm.$t("about-us")) + "\n        ")
          ]),
          _vm._v(" "),
          _c("v-btn", { attrs: { to: "our-services", text: "" } }, [
            _vm._v(
              "\n            " + _vm._s(_vm.$t("our-services")) + "\n        "
            )
          ]),
          _vm._v(" "),
          _c("v-btn", { attrs: { to: "projects", text: "" } }, [
            _vm._v("\n            " + _vm._s(_vm.$t("projects")) + "\n        ")
          ]),
          _vm._v(" "),
          _c("v-btn", { attrs: { to: "donations", text: "" } }, [
            _vm._v(
              "\n            " + _vm._s(_vm.$t("donations")) + "\n        "
            )
          ]),
          _vm._v(" "),
          _c("v-btn", { attrs: { to: "contact-us", text: "" } }, [
            _vm._v(
